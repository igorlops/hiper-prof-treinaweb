...
export const BoxImage = styled(Box, {shouldForwardProp: (props) => props !== "foto",})<{foto?: string}>`
    display: flex;
    align-items: center;
    justify-content: center;
    background: no-repeat center/cover ${({foto}) =>  `url(${foto ?? '/user.svg'})`};
    height: 100%;
